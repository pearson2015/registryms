pipeline {
    agent any
    environment {
        registry = "mydarkworld/registryms"
    ...
    stages {
        stage('Checkout') {
            steps {
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'mygithubkey', url: 'git@github.com:pearson2015/registryms.git']])
            }
        }
